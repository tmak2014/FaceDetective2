...
public class FdActivity extends javax.swing.JFrame {
	...
	private Point setting_center=null;
...
//        	}
    ...
    {
    	setting_center = blackeye_center;
    }
...
/*
    	switch(direction){
    		case 4: 
    			try {
    				  readImage = ImageIO.read(new File("L.jpg"));
    				} catch (Exception e) {
    				  e.printStackTrace();
    				  readImage = null;
    				}
            	...
            	while (runnable) {
                    ...
                    if (webSource.grab()) {
                        ...
                        try {
                            ...
                            if(setting_center!=null) {



                            	diff_x=blackeye_center.x-setting_center.x;

                            	diff_y=blackeye_center.y-setting_center.y;
                            ...
                            g.drawString(String.valueOf(setting_center), 20, 80);

                            g.drawString(String.valueOf(blackeye_center), 20, 100);
                            
                            g.drawString(String.valueOf(diff_x), 20, 120);

                            g.drawString(String.valueOf(diff_y), 20, 140);

                            g.drawString(String.valueOf(direction), 20, 160);
...
/////////
    ...
    public FdActivity() {
        ...
        System.out.println(getClass().getResource("/haarcascade_frontalface_alt.xml").getPath().substring(1));
...
//            .addGap(0, 376, Short.MAX_VALUE)
        ...
        jPanel_direction.setPreferredSize(new Dimension(100, 100));
...
//      boolean setFps = webSource.set(Videoio.CAP_PROP_FPS, 15);
